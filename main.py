...
def get_squads(seasons: list, leagues: list, countries: list) -> list:
    squads = list(col.find({'$and': [{'general.season': {'$in': seasons}, 'general.league': {'$in': leagues}, 'general.country': {"$in": countries}}]}).distinct('teams.home.name'))
